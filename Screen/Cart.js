...
export default class CartScreen extends Component {
  ...
  render() {
    ...
    return (
      <Container>
        <Header style={{backgroundColor:'green'}} searchBar rounded hasTabs androidStatusBarColor={'black'}>
          <Left>
            <Button transparent >
        ...
        <Button style={{backgroundColor:'red'}} onPress={() => navigate('CheckoutScreen')} success full><Text>Checkout</Text></Button>
      </Container>     
    )
  }
}
